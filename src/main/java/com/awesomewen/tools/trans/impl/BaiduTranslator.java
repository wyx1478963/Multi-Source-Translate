...
import static com.awesomewen.tools.constants.JSFileList.BAIDU_TOKEN_JS;
...
public final class BaiduTranslator extends AbstractTranslator {
    ...
    public void setFormData(LANG from, LANG to, String text) {
        ...
        formData.put("sign", TokenUtils.generateTokenByJsWithGtk(text, BAIDU_TOKEN_JS, "320305.131321201"));
    ...
    public String query() throws Exception {
        ...
        request.setEntity(new UrlEncodedFormEntity(TranslateUtils.map2list(formData), "UTF-8"));
