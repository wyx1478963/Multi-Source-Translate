...
public final class YoudaoTranslator extends AbstractTranslator {
    ...
    public void setFormData(LANG from, LANG to, String text) {
        ...
        String sign = TranslateUtils.md5("fanyideskweb" + text + slat + "ebSeFb%=XZ%T[KZ)c(sy!");
    ...
    public String query() throws Exception {
        HttpPost request = new HttpPost(TranslateUtils.getUrlWithQueryString(url, formData));
